module.exports = {
	HVS2000: {
		...
		VARIABLES: [
			{ name: 'Last global event to be recalled', variableId: 'global_event_recall' },
			{ name: 'Last ME1 event to be recalled', variableId: 'me_1_event_recall' },
			{ name: 'Last ME2 event to be recalled', variableId: 'me_2_event_recall' },
			{ name: 'Last ME3 event to be recalled', variableId: 'me_3_event_recall' },
